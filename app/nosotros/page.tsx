...
export const metadata: Metadata = {
  ...
  description:
    "Conoce a Dental Company, centro odontológico en Tacna con más de 17 años de experiencia. Nuestro equipo de especialistas, misión, visión y compromiso con tu salud bucal.",
  alternates: {
    canonical: "/nosotros",
  },
  openGraph: {
            ...
            <div>
              ...
              <div className='space-y-4 text-gray-600 leading-relaxed'>
                ...
                <p>
                  ...
                  miles de pacientes que confían en nosotros para el cuidado de
                  su salud bucal.
                </p>
                <p>
                  Nos encontramos en el corazón de Tacna, ciudad fronteriza
                  conocida por su rica historia, su gastronomía y su gente
                  acogedora. Tacna, la &ldquo;Ciudad Heroica&rdquo;, nos inspira
                  con su espíritu de perseverancia y excelencia que reflejamos
                  en cada tratamiento.
                </p>
              </div>
            </div>
          ...
          <div className='grid md:grid-cols-3 gap-8'>
            ...
            <div className='bg-gradient-to-br from-blue-50 to-blue-100 rounded-3xl p-8'>
              ...
              <p className='text-gray-600 leading-relaxed'>
                ...
                utilizando tecnología avanzada y un enfoque humano, para mejorar
                la salud bucal y la calidad de vida de nuestros pacientes en
            ...
            <div className='bg-gradient-to-br from-green-50 to-green-100 rounded-3xl p-8'>
              ...
              <p className='text-gray-600 leading-relaxed'>
                ...
                reconocido por la excelencia en tratamientos especializados, la
                innovación constante y el compromiso con la satisfacción total
      ...
      <section className='py-16 sm:py-20 bg-white'>
        <div className='container mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center mb-12'>
            ...
            <p className='text-gray-600 max-w-2xl mx-auto'>
              Conoce a los especialistas que harán de tu visita una experiencia
