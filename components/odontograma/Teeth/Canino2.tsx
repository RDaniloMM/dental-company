...
export default function Canino2({ toothId, data, onPartClick, onNumberClick }: Props) {
  // ============================
  ...
  return (
    <div style={{ display: "inline-block", textAlign: "center", margin: "0 2px" }}>
      {/* Número del diente */}
      <div
        style={{ cursor: "pointer", marginBottom: 4, fontSize: 12, fontWeight: "bold" }}
      ...
      <div style={{ height: "60%" }}>
        ...
        >
          {/** ==============================
           * 1) IMAGEN BASE DEL CANINO
           * ============================== */}
          <svg viewBox="0 0 210 250" xmlns="http://www.w3.org/2000/svg">
            <path d="M 85.813647,126.34345 H 171.42454 L 128.61911,15.325288 Z" stroke="#000" fill="white" strokeWidth="2.48"/>
            <path d="M 41.813647,126.34358 H 127.42455 L 84.619116,15.32541 Z" stroke="#000" fill="white" strokeWidth="2.48"/>

              <rect x="19.642595" y="126.00449" width="174.24286" height="114.03075" stroke="#000" fill="white" strokeWidth="2.48"/>

            <g transform="matrix(0.99952832,0,0,1.1286498,0.05033008,-16.21145)">
              <rect x="55.995895" y="150.21916" width="102.11989" height="55.186192" stroke="#000" fill="white" strokeWidth="2.38"/>
              <path d="M 56.861637,178.26189 158.74415,177.87153" stroke="#000" fill="none" strokeWidth="1.94"/>
              <path d="m 19.517724,126.73509 36.17285,23.42127" stroke="#000" fill="none" strokeWidth="1.94"/>
              <path d="M 19.77796,226.66583 55.430337,205.06622" stroke="#000" fill="none" strokeWidth="1.94"/>
              <path d="m 158.22368,204.80598 35.39214,21.59962" stroke="#000" fill="none" strokeWidth="1.94"/>
              <path d="m 158.74416,150.15636 35.1319,-23.68151" stroke="#000" fill="none" strokeWidth="1.94"/>
            </g>
          </svg>
          {/** ==============================
