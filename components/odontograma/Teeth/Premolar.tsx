...
export default function Premolar({ toothId, data, onPartClick, onNumberClick }: Props) {
  // ============================
  ...
  return (
    <div style={{ display: "inline-block", textAlign: "center", margin: "0 2px" }}>
      ...
      <div style={{ height: "60%" }}>
        ...
        >
          {/** ==============================
           * 1) IMAGEN BASE DEL PREMOLAR (decorativa)
           * ============================== */}
          <svg viewBox="0 0 210 250" xmlns="http://www.w3.org/2000/svg">
            <path d="M 64.293991,126.34358 H 149.90489 L 107.09946,15.32541 Z" stroke="#000" fill="white" strokeWidth="2.48"/>
