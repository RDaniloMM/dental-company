  ...
  return (
    ...
    >
      <DialogPrimitive.Portal>
        ...
        <DialogPrimitive.Content className='fixed inset-0 z-50 flex items-center justify-center bg-black/95'>
              ...
              <div className='flex items-start justify-between gap-2'>
                ...
                <div className='flex flex-wrap items-center gap-1.5 sm:gap-2 min-w-0'>
                  ...
                  {etapaInfo && (
                    <Badge
                      variant='outline'
                      className={`${etapaInfo.color} text-xs border-white/30`}
                    >
                      {etapaInfo.label}
                    </Badge>
                  )}
                  {image.caso && (
                    <Badge
                      variant='outline'
                      className='bg-blue-500/20 text-blue-200 border-blue-400/30 text-xs hidden sm:flex'
                    >
