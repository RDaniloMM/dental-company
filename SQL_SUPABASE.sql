...
CREATE TABLE public.seguimiento_audit_log (
  ...
  CONSTRAINT seguimiento_audit_log_seguimiento_id_fkey FOREIGN KEY (seguimiento_id) REFERENCES public.seguimientos(id),
...
CREATE TABLE public.seguimientos (
  ...
  CONSTRAINT seguimientos_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.personal(id),
  CONSTRAINT seguimientos_updated_by_fkey FOREIGN KEY (updated_by) REFERENCES public.personal(id),
  CONSTRAINT seguimientos_deleted_by_fkey FOREIGN KEY (deleted_by) REFERENCES public.personal(id),
